...
const WeddingPage = (props) => {
    return (
        <Layout location={props.location}>
            ...
            <ChurchImage />
            <Container>
                <Typography variant="h2">Vigsel</Typography>
                <Typography variant="body1">
                    Vigseln kommer att äga rum klockan 14.00 i Föra kyrka, Föra Kyrkgata 1, 387 91 Borgholm.
            </Typography><br/>
                <Typography variant="body1">
                    ...
                    Närmaste busshållplats heter "Föra vsk" och den ligger 1,5 km från kyrkan och festlokalen. Har du funderingar hur du ska komma till kyrkan är det bara att höra av dig!</Typography>
                    <br/>
                <Typography variant="body1">
                    Vad ska man då ha för kläder? Klädkoden för dagen är sommarfin så ta på dig det som du känner dig fin i.
</Typography>
